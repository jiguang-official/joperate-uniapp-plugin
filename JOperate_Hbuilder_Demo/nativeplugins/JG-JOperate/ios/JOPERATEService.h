...
#define JOPERATE_VERSION_NUMBER 2.0.0
 ...
 */
+ (void)setupWithConfig:(JOPERATEConfig *)config;
...
/**
 ...
 @param url 回调的url，在 Appdelegate 的 application:handleOpenURL: 中调用。不调用此接口 JOPERATE 将无法进入debug模式。
 */
